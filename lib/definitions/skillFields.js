const SKILL_FIELD_NAMES = {
  ...
  'OVERRIDE_MIN_A_P':'OverrideMinAP',
  'STEALTH':'Stealth',
...
const PROJECTILE_NAMES = {
  ...
  'COOLDOWN': 'Cooldown',
  /**
	* Value must be one of the values from the A_I_FLAGS enum. You can import this via const { A_I_FLAGS } = require('./lib/definitions/enums');
	*/
  'A_I_FLAGS': 'AIFlags',
  /**
